...
@RequestMapping(value = UsercenterSecurityConfigure.CONTROLLER + "/zookeeper/config", methods = { HttpMethod.GET,
		HttpMethod.POST })
public class ZookeeperConfigController {
	...
	public ModelAndView view(String key) {
		ModelAndView page = new ModelAndView("/io/basc/start/admin/web/ftl/config_view.ftl");
		page.put("key", key);
		page.put("value", cloudPropertyFactory.getAsString(key));
		return page;
	}
