...
public class EditorInfoPage extends EditorCURD {
	...
	public EditorInfoPage(EditableMapper mapper, CurdRepository repository,
			Class<?> editableClass, AppConfigure appConfigure,
			ResultFactory resultFactory) {
		super(mapper, repository, editableClass, appConfigure, HttpMethod.GET,
				resultFactory, "info");
	}
	...
	public Object doAction(HttpChannel httpChannel) {
		...
		Object info = getRepository()
				.queryAll((Class) getEditableClass(), requestBean).findAny()
				.get();
