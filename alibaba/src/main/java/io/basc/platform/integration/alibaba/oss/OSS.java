package io.basc.platform.integration.alibaba.oss;
...
public final class OSS {
	...
	public ObjectListing myListObject(String bucketName, String prefix, int limit, String nextMarker) {
		...
		return objectListing == null ? null : new io.basc.platform.integration.alibaba.oss.ObjectListing(objectListing);
	}
