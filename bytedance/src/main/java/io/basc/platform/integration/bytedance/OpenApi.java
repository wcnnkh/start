...
import io.basc.platform.integration.bytedance.comment.CommentApiType;
import io.basc.platform.integration.bytedance.comment.CommentListRequest;
import io.basc.platform.integration.bytedance.comment.CommentListResponse;
import io.basc.platform.integration.bytedance.comment.CommentReplyListRequest;
import io.basc.platform.integration.bytedance.comment.CommentReplyRequest;
import io.basc.platform.integration.bytedance.comment.CommentReplyResponse;
import io.basc.platform.integration.bytedance.comment.EnterpriseImMessageSendRequest;
import io.basc.platform.integration.bytedance.comment.EnterpriseImMessageSendResponse;
import io.basc.platform.integration.bytedance.data.AmusementRankApiType;
import io.basc.platform.integration.bytedance.data.CarRankApiType;
import io.basc.platform.integration.bytedance.data.CospaRankApiType;
import io.basc.platform.integration.bytedance.data.DataExternBillboard;
import io.basc.platform.integration.bytedance.data.DataExternBillboardHotVideo;
import io.basc.platform.integration.bytedance.data.DataExternBillboardLive;
import io.basc.platform.integration.bytedance.data.DataExternBillboardMusic;
import io.basc.platform.integration.bytedance.data.DataExternBillboardProp;
import io.basc.platform.integration.bytedance.data.DataExternBillboardStars;
import io.basc.platform.integration.bytedance.data.DataExternBillboardTopic;
import io.basc.platform.integration.bytedance.data.DataExternFansComment;
import io.basc.platform.integration.bytedance.data.DataExternFansFavourite;
import io.basc.platform.integration.bytedance.data.DataExternFansSource;
import io.basc.platform.integration.bytedance.data.DataExternalAnchorMpItemClickDistribution;
import io.basc.platform.integration.bytedance.data.DataExternalAnchorMpItemClickDistributionRequest;
import io.basc.platform.integration.bytedance.data.DataExternalItemBaseRequest;
import io.basc.platform.integration.bytedance.data.DataExternalItemBaseResponse;
import io.basc.platform.integration.bytedance.data.DataExternalItemComment;
import io.basc.platform.integration.bytedance.data.DataExternalItemLike;
import io.basc.platform.integration.bytedance.data.DataExternalItemPlay;
import io.basc.platform.integration.bytedance.data.DataExternalItemRequest;
import io.basc.platform.integration.bytedance.data.DataExternalItemShare;
import io.basc.platform.integration.bytedance.data.DataExternalSdkShare;
import io.basc.platform.integration.bytedance.data.DataExternalUserComment;
import io.basc.platform.integration.bytedance.data.DataExternalUserFans;
import io.basc.platform.integration.bytedance.data.DataExternalUserItem;
import io.basc.platform.integration.bytedance.data.DataExternalUserLike;
import io.basc.platform.integration.bytedance.data.DataExternalUserProfile;
import io.basc.platform.integration.bytedance.data.DataExternalUserRequest;
import io.basc.platform.integration.bytedance.data.DataExternalUserResponse;
import io.basc.platform.integration.bytedance.data.DataExternalUserShare;
import io.basc.platform.integration.bytedance.data.DiscoveryEntRankItemRequest;
import io.basc.platform.integration.bytedance.data.DiscoveryEntRankItemResponse;
import io.basc.platform.integration.bytedance.data.DiscoveryEntRrankVersion;
import io.basc.platform.integration.bytedance.data.DiscoveryEntRrankVersionRequest;
import io.basc.platform.integration.bytedance.data.FansDataResponse;
import io.basc.platform.integration.bytedance.data.FoodRankApiType;
import io.basc.platform.integration.bytedance.data.GameRankApiType;
import io.basc.platform.integration.bytedance.data.HotsearchSentencesResponse;
import io.basc.platform.integration.bytedance.data.HotsearchTrendingSentences;
import io.basc.platform.integration.bytedance.data.HotsearchVideosRequest;
import io.basc.platform.integration.bytedance.data.MusicRankApiType;
import io.basc.platform.integration.bytedance.data.SportRankApiType;
import io.basc.platform.integration.bytedance.data.StarAuthorScore;
import io.basc.platform.integration.bytedance.data.StarAuthorScoreV2Request;
import io.basc.platform.integration.bytedance.data.StarAuthorScoreV2Response;
import io.basc.platform.integration.bytedance.data.StarHotListRequest;
import io.basc.platform.integration.bytedance.data.StarHotListResponse;
import io.basc.platform.integration.bytedance.data.TravelRankApiType;
import io.basc.platform.integration.bytedance.devtool.DevtoolMicappIsLegalRequest;
import io.basc.platform.integration.bytedance.devtool.DevtoolMicappIsLegalResponse;
import io.basc.platform.integration.bytedance.devtool.JsGetticketResponse;
import io.basc.platform.integration.bytedance.devtool.SandboxWebhookEventSendRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseImCardDeleteRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseImCardListResponse;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseImCardSaveRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseImCardSaveResponse;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsTagResponse;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsTagUserListRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsTagUserUpdateRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserAction;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserActionListRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserDetailRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserDetailResponse;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserListRequest;
import io.basc.platform.integration.bytedance.enterprise.EnterpriseLeadsUserListResponse;
import io.basc.platform.integration.bytedance.enterprise.Tag;
...
import io.basc.platform.integration.bytedance.oauth.OauthAccessTokenRequest;
import io.basc.platform.integration.bytedance.oauth.OauthAccessTokenResponse;
import io.basc.platform.integration.bytedance.oauth.OauthClientTokenRequest;
import io.basc.platform.integration.bytedance.oauth.OauthClientTokenResponse;
import io.basc.platform.integration.bytedance.oauth.OauthRefreshTokenRequest;
import io.basc.platform.integration.bytedance.oauth.OauthRenewRefreshTokenRequest;
import io.basc.platform.integration.bytedance.oauth.OauthRenewRefreshTokenResponse;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiBaseRequest;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiBaseResult;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiBillboardRequest;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiBillboardResult;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiClaim;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiClaimListRequest;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiServiceBaseRequest;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiServiceBaseResult;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiServiceUserRequest;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiUser;
import io.basc.platform.integration.bytedance.poi.DataExternalPoiUserRequest;
import io.basc.platform.integration.bytedance.poi.MatchResultList;
import io.basc.platform.integration.bytedance.poi.PoiBaseQueryAmapRequest;
import io.basc.platform.integration.bytedance.poi.PoiBaseQueryAmapResponse;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderCancelRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderCancelResponse;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderCommitRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderCommitResponse;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderStatusRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelOrderStatusResponse;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelSku;
import io.basc.platform.integration.bytedance.poi.PoiExtHotelSkuRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtPresaleGrouponOrder;
import io.basc.platform.integration.bytedance.poi.PoiExtPresaleGrouponOrderCommitRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtPresaleGrouponOrderCreateRequest;
import io.basc.platform.integration.bytedance.poi.PoiExtPresaleGrouponOrderCreateResponse;
import io.basc.platform.integration.bytedance.poi.PoiOrderBillToken;
import io.basc.platform.integration.bytedance.poi.PoiOrderBillTokenRequest;
import io.basc.platform.integration.bytedance.poi.PoiOrderConfirmRequest;
import io.basc.platform.integration.bytedance.poi.PoiOrderConfirmResponse;
import io.basc.platform.integration.bytedance.poi.PoiOrderListToken;
import io.basc.platform.integration.bytedance.poi.PoiOrderListTokenRequest;
import io.basc.platform.integration.bytedance.poi.PoiOrderStatusRequest;
import io.basc.platform.integration.bytedance.poi.PoiOrderSyncRequest;
import io.basc.platform.integration.bytedance.poi.PoiOrderSyncResponse;
import io.basc.platform.integration.bytedance.poi.PoiQueryRequest;
import io.basc.platform.integration.bytedance.poi.PoiQueryResponse;
import io.basc.platform.integration.bytedance.poi.PoiSkuSyncRequest;
import io.basc.platform.integration.bytedance.poi.PoiSpuQueryRequest;
import io.basc.platform.integration.bytedance.poi.PoiSpuQueryResponse;
import io.basc.platform.integration.bytedance.poi.PoiSupplier;
import io.basc.platform.integration.bytedance.poi.PoiSupplierQueryRequest;
import io.basc.platform.integration.bytedance.poi.PoiSupplierQueryResponse;
import io.basc.platform.integration.bytedance.poi.PoiSupplierSyncResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuGetRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuGetResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStatusRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStatusResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStatusSyncRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStatusSyncResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStockUpdateRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuStockUpdateResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuSyncRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuSyncResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuTakeRateSyncRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SpuTakeRateSyncResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SupplierMatchRequest;
import io.basc.platform.integration.bytedance.poi.PoiV2SupplierMatchResponse;
import io.basc.platform.integration.bytedance.poi.PoiV2SupplierQuerySupplier;
import io.basc.platform.integration.bytedance.poi.PoiV2SupplierQueryTask;
import io.basc.platform.integration.bytedance.poi.PoiV2SupplierQueryTaskRequest;
import io.basc.platform.integration.bytedance.search.VideoSearchCommentListRequest;
import io.basc.platform.integration.bytedance.search.VideoSearchCommentReplyListRequest;
import io.basc.platform.integration.bytedance.search.VideoSearchCommentReplyRequest;
import io.basc.platform.integration.bytedance.search.VideoSearchRequest;
import io.basc.platform.integration.bytedance.search.VideoSearchResponse;
import io.basc.platform.integration.bytedance.user.FansCheckRequest;
import io.basc.platform.integration.bytedance.user.FansCheckResponse;
import io.basc.platform.integration.bytedance.user.FansListResponse;
import io.basc.platform.integration.bytedance.user.FollowingListResponse;
import io.basc.platform.integration.bytedance.user.UserPagingRequest;
import io.basc.platform.integration.bytedance.user.UserRequest;
import io.basc.platform.integration.bytedance.user.UserinfoResponse;
import io.basc.platform.integration.bytedance.video.CreateResponse;
import io.basc.platform.integration.bytedance.video.ImageCreateRequest;
import io.basc.platform.integration.bytedance.video.ImageUploadResponse;
import io.basc.platform.integration.bytedance.video.PoiSearchKeywordRequest;
import io.basc.platform.integration.bytedance.video.PoiSearchKeywordResponse;
import io.basc.platform.integration.bytedance.video.ShareIdRequest;
import io.basc.platform.integration.bytedance.video.ShareIdResponse;
import io.basc.platform.integration.bytedance.video.VdeoPartUploadRequest;
import io.basc.platform.integration.bytedance.video.VideoCreateRequest;
import io.basc.platform.integration.bytedance.video.VideoData;
import io.basc.platform.integration.bytedance.video.VideoDataResponse;
import io.basc.platform.integration.bytedance.video.VideoListResponse;
import io.basc.platform.integration.bytedance.video.VideoPartInitResponse;
import io.basc.platform.integration.bytedance.video.VideoPartRequest;
import io.basc.platform.integration.bytedance.video.VideoUploadResponse;
