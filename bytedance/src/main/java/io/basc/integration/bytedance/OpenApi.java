...
import io.basc.integration.bytedance.comment.CommentApiType;
import io.basc.integration.bytedance.comment.CommentListRequest;
import io.basc.integration.bytedance.comment.CommentListResponse;
import io.basc.integration.bytedance.comment.CommentReplyListRequest;
import io.basc.integration.bytedance.comment.CommentReplyRequest;
import io.basc.integration.bytedance.comment.CommentReplyResponse;
import io.basc.integration.bytedance.comment.EnterpriseImMessageSendRequest;
import io.basc.integration.bytedance.comment.EnterpriseImMessageSendResponse;
import io.basc.integration.bytedance.data.AmusementRankApiType;
import io.basc.integration.bytedance.data.CarRankApiType;
import io.basc.integration.bytedance.data.CospaRankApiType;
import io.basc.integration.bytedance.data.DataExternBillboard;
import io.basc.integration.bytedance.data.DataExternBillboardHotVideo;
import io.basc.integration.bytedance.data.DataExternBillboardLive;
import io.basc.integration.bytedance.data.DataExternBillboardMusic;
import io.basc.integration.bytedance.data.DataExternBillboardProp;
import io.basc.integration.bytedance.data.DataExternBillboardStars;
import io.basc.integration.bytedance.data.DataExternBillboardTopic;
import io.basc.integration.bytedance.data.DataExternFansComment;
import io.basc.integration.bytedance.data.DataExternFansFavourite;
import io.basc.integration.bytedance.data.DataExternFansSource;
import io.basc.integration.bytedance.data.DataExternalAnchorMpItemClickDistribution;
import io.basc.integration.bytedance.data.DataExternalAnchorMpItemClickDistributionRequest;
import io.basc.integration.bytedance.data.DataExternalItemBaseRequest;
import io.basc.integration.bytedance.data.DataExternalItemBaseResponse;
import io.basc.integration.bytedance.data.DataExternalItemComment;
import io.basc.integration.bytedance.data.DataExternalItemLike;
import io.basc.integration.bytedance.data.DataExternalItemPlay;
import io.basc.integration.bytedance.data.DataExternalItemRequest;
import io.basc.integration.bytedance.data.DataExternalItemShare;
import io.basc.integration.bytedance.data.DataExternalSdkShare;
import io.basc.integration.bytedance.data.DataExternalUserComment;
import io.basc.integration.bytedance.data.DataExternalUserFans;
import io.basc.integration.bytedance.data.DataExternalUserItem;
import io.basc.integration.bytedance.data.DataExternalUserLike;
import io.basc.integration.bytedance.data.DataExternalUserProfile;
import io.basc.integration.bytedance.data.DataExternalUserRequest;
import io.basc.integration.bytedance.data.DataExternalUserResponse;
import io.basc.integration.bytedance.data.DataExternalUserShare;
import io.basc.integration.bytedance.data.DiscoveryEntRankItemRequest;
import io.basc.integration.bytedance.data.DiscoveryEntRankItemResponse;
import io.basc.integration.bytedance.data.DiscoveryEntRrankVersion;
import io.basc.integration.bytedance.data.DiscoveryEntRrankVersionRequest;
import io.basc.integration.bytedance.data.FansDataResponse;
import io.basc.integration.bytedance.data.FoodRankApiType;
import io.basc.integration.bytedance.data.GameRankApiType;
import io.basc.integration.bytedance.data.HotsearchSentencesResponse;
import io.basc.integration.bytedance.data.HotsearchTrendingSentences;
import io.basc.integration.bytedance.data.HotsearchVideosRequest;
import io.basc.integration.bytedance.data.MusicRankApiType;
import io.basc.integration.bytedance.data.SportRankApiType;
import io.basc.integration.bytedance.data.StarAuthorScore;
import io.basc.integration.bytedance.data.StarAuthorScoreV2Request;
import io.basc.integration.bytedance.data.StarAuthorScoreV2Response;
import io.basc.integration.bytedance.data.StarHotListRequest;
import io.basc.integration.bytedance.data.StarHotListResponse;
import io.basc.integration.bytedance.data.TravelRankApiType;
import io.basc.integration.bytedance.devtool.DevtoolMicappIsLegalRequest;
import io.basc.integration.bytedance.devtool.DevtoolMicappIsLegalResponse;
import io.basc.integration.bytedance.devtool.JsGetticketResponse;
import io.basc.integration.bytedance.devtool.SandboxWebhookEventSendRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseImCardDeleteRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseImCardListResponse;
import io.basc.integration.bytedance.enterprise.EnterpriseImCardSaveRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseImCardSaveResponse;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsTagResponse;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsTagUserListRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsTagUserUpdateRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserAction;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserActionListRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserDetailRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserDetailResponse;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserListRequest;
import io.basc.integration.bytedance.enterprise.EnterpriseLeadsUserListResponse;
import io.basc.integration.bytedance.enterprise.Tag;
import io.basc.integration.bytedance.oauth.ClientPagingRequest;
import io.basc.integration.bytedance.oauth.ClientRequest;
import io.basc.integration.bytedance.oauth.OauthAccessTokenRequest;
import io.basc.integration.bytedance.oauth.OauthAccessTokenResponse;
import io.basc.integration.bytedance.oauth.OauthClientTokenRequest;
import io.basc.integration.bytedance.oauth.OauthClientTokenResponse;
import io.basc.integration.bytedance.oauth.OauthRefreshTokenRequest;
import io.basc.integration.bytedance.oauth.OauthRenewRefreshTokenRequest;
import io.basc.integration.bytedance.oauth.OauthRenewRefreshTokenResponse;
import io.basc.integration.bytedance.poi.DataExternalPoiBaseRequest;
import io.basc.integration.bytedance.poi.DataExternalPoiBaseResult;
import io.basc.integration.bytedance.poi.DataExternalPoiBillboardRequest;
import io.basc.integration.bytedance.poi.DataExternalPoiBillboardResult;
import io.basc.integration.bytedance.poi.DataExternalPoiClaim;
import io.basc.integration.bytedance.poi.DataExternalPoiClaimListRequest;
import io.basc.integration.bytedance.poi.DataExternalPoiServiceBaseRequest;
import io.basc.integration.bytedance.poi.DataExternalPoiServiceBaseResult;
import io.basc.integration.bytedance.poi.DataExternalPoiServiceUserRequest;
import io.basc.integration.bytedance.poi.DataExternalPoiUser;
import io.basc.integration.bytedance.poi.DataExternalPoiUserRequest;
import io.basc.integration.bytedance.poi.MatchResultList;
import io.basc.integration.bytedance.poi.PoiBaseQueryAmapRequest;
import io.basc.integration.bytedance.poi.PoiBaseQueryAmapResponse;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderCancelRequest;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderCancelResponse;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderCommitRequest;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderCommitResponse;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderStatusRequest;
import io.basc.integration.bytedance.poi.PoiExtHotelOrderStatusResponse;
import io.basc.integration.bytedance.poi.PoiExtHotelSku;
import io.basc.integration.bytedance.poi.PoiExtHotelSkuRequest;
import io.basc.integration.bytedance.poi.PoiExtPresaleGrouponOrder;
import io.basc.integration.bytedance.poi.PoiExtPresaleGrouponOrderCommitRequest;
import io.basc.integration.bytedance.poi.PoiExtPresaleGrouponOrderCreateRequest;
import io.basc.integration.bytedance.poi.PoiExtPresaleGrouponOrderCreateResponse;
import io.basc.integration.bytedance.poi.PoiOrderBillToken;
import io.basc.integration.bytedance.poi.PoiOrderBillTokenRequest;
import io.basc.integration.bytedance.poi.PoiOrderConfirmRequest;
import io.basc.integration.bytedance.poi.PoiOrderConfirmResponse;
import io.basc.integration.bytedance.poi.PoiOrderListToken;
import io.basc.integration.bytedance.poi.PoiOrderListTokenRequest;
import io.basc.integration.bytedance.poi.PoiOrderStatusRequest;
import io.basc.integration.bytedance.poi.PoiOrderSyncRequest;
import io.basc.integration.bytedance.poi.PoiOrderSyncResponse;
import io.basc.integration.bytedance.poi.PoiQueryRequest;
import io.basc.integration.bytedance.poi.PoiQueryResponse;
import io.basc.integration.bytedance.poi.PoiSkuSyncRequest;
import io.basc.integration.bytedance.poi.PoiSpuQueryRequest;
import io.basc.integration.bytedance.poi.PoiSpuQueryResponse;
import io.basc.integration.bytedance.poi.PoiSupplier;
import io.basc.integration.bytedance.poi.PoiSupplierQueryRequest;
import io.basc.integration.bytedance.poi.PoiSupplierQueryResponse;
import io.basc.integration.bytedance.poi.PoiSupplierSyncResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuGetRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuGetResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuStatusRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuStatusResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuStatusSyncRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuStatusSyncResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuStockUpdateRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuStockUpdateResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuSyncRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuSyncResponse;
import io.basc.integration.bytedance.poi.PoiV2SpuTakeRateSyncRequest;
import io.basc.integration.bytedance.poi.PoiV2SpuTakeRateSyncResponse;
import io.basc.integration.bytedance.poi.PoiV2SupplierMatchRequest;
import io.basc.integration.bytedance.poi.PoiV2SupplierMatchResponse;
import io.basc.integration.bytedance.poi.PoiV2SupplierQuerySupplier;
import io.basc.integration.bytedance.poi.PoiV2SupplierQueryTask;
import io.basc.integration.bytedance.poi.PoiV2SupplierQueryTaskRequest;
import io.basc.integration.bytedance.search.VideoSearchCommentListRequest;
import io.basc.integration.bytedance.search.VideoSearchCommentReplyListRequest;
import io.basc.integration.bytedance.search.VideoSearchCommentReplyRequest;
import io.basc.integration.bytedance.search.VideoSearchRequest;
import io.basc.integration.bytedance.search.VideoSearchResponse;
import io.basc.integration.bytedance.user.FansCheckRequest;
import io.basc.integration.bytedance.user.FansCheckResponse;
import io.basc.integration.bytedance.user.FansListResponse;
import io.basc.integration.bytedance.user.FollowingListResponse;
import io.basc.integration.bytedance.user.UserPagingRequest;
import io.basc.integration.bytedance.user.UserRequest;
import io.basc.integration.bytedance.user.UserinfoResponse;
import io.basc.integration.bytedance.video.CreateResponse;
import io.basc.integration.bytedance.video.ImageCreateRequest;
import io.basc.integration.bytedance.video.ImageUploadResponse;
import io.basc.integration.bytedance.video.PoiSearchKeywordRequest;
import io.basc.integration.bytedance.video.PoiSearchKeywordResponse;
import io.basc.integration.bytedance.video.ShareIdRequest;
import io.basc.integration.bytedance.video.ShareIdResponse;
import io.basc.integration.bytedance.video.VdeoPartUploadRequest;
import io.basc.integration.bytedance.video.VideoCreateRequest;
import io.basc.integration.bytedance.video.VideoData;
import io.basc.integration.bytedance.video.VideoDataResponse;
import io.basc.integration.bytedance.video.VideoListResponse;
import io.basc.integration.bytedance.video.VideoPartInitResponse;
import io.basc.integration.bytedance.video.VideoPartRequest;
import io.basc.integration.bytedance.video.VideoUploadResponse;
