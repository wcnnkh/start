...
import io.basc.satrt.admin.web.editable.Editor;
import io.basc.satrt.admin.web.editable.annotation.Editable;
import io.basc.satrt.admin.web.editable.annotation.Image;
import io.basc.satrt.admin.web.editable.annotation.Readonly;
import io.basc.satrt.admin.web.editable.annotation.Select;
import io.basc.satrt.admin.web.editable.annotation.SelectOption;
import io.basc.satrt.admin.web.editable.annotation.Textarea;
import io.basc.satrt.admin.web.editable.form.ImageInput;
import io.basc.satrt.admin.web.editable.form.Input;
import io.basc.satrt.admin.web.editable.form.SelectInput;
import io.basc.satrt.admin.web.editable.form.TextareaInput;
