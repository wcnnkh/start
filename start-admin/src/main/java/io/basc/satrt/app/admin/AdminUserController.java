...
public class AdminUserController {
	...
	public ModelAndView admin_list(UserToken<Long> requestUser, Integer groupId, @DefaultValue("1") int page,
		...
		ModelAndView view = new ModelAndView("/io/basc/start/admin/web/ftl/admin_list.ftl");
	...
	public Object admin_view(long toUid, UserToken<Long> requestUser) {
		ModelAndView page = new ModelAndView("/io/basc/start/admin/web/ftl/admin_view.ftl");
