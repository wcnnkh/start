...
public class PermissionGroupController {
	...
	public ModelAndView group_list(UserToken<Long> requestUser, Integer parentId) {
		...
		ModelAndView page = new ModelAndView("/io/basc/start/admin/web/ftl/group_list.ftl");
	...
	public Object group_view(int parentId, int id) {
		ModelAndView page = new ModelAndView("/io/basc/start/admin/web/ftl/group_view.ftl");
